...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadReviews() {
        ...
        try {
            ...
            if (
                ...
                homeReviewsContainer.insertAdjacentHTML(
                    "afterbegin",
                    reviewsHTML
                );
        ...
        reviewForm.addEventListener(
            ...
            async (event) => {
                ...
                if (
                    ...
                    alert(
                        "Completá barrio, título, calificación y reseña."
                    );
    ...
    console.log(
        "ReseñaTuApto funcionando correctamente."
    );
